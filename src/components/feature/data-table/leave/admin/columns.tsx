...
import AdminLeaveTableRowActions from "./AdminLeaveTableRowActions";
import { differenceInDays } from "date-fns";

const columnHelper = createColumnHelper<StudentLeaveRecord>();

export const adminLeaveTableColumns = [
  ...
  columnHelper.accessor(
    (row) => `${row.student.first_name} ${row.student.last_name}`,
    {
      id: "student",
      header: ({ column }) => (
  ...
  columnHelper.display({
    id: "actions",
    header: "Actions",
    cell: ({ row }) => <AdminLeaveTableRowActions row={row} />,
  }),
] as ColumnDef<StudentLeaveRecord, string>[];
